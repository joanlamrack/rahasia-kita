	...
	render() {
		return (
			<div>
				...
				<p>
					Rahasia Kita ("us", "we", or "our") operates the
					https://rahasiakita-90c65.firebaseapp.com website (hereinafter
				...
				<p>
					...
					Rahasia Kita is managed with the help of{" "}
				...
				<p>
					...
					https://rahasiakita-90c65.firebaseapp.com
				</p>
				...
				<p>Rahasia Kita uses the collected data for various purposes:</p>
				<ul>
				...
				<p>
					...
					to Indonesia and process it there.
				</p>
				<p>
				...
				<p>
					Rahasia Kita will take all steps reasonably necessary to ensure that
				...
				<p>
					Rahasia Kita may disclose your Personal Data in the good faith belief
					that such action is necessary to:
				</p>
				<ul>
					<li>To comply with a legal obligation</li>
					<li>To protect and defend the rights or property of Rahasia Kita</li>
					<li>
